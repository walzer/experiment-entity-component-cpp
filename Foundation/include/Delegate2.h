#ifndef __FOUNDATION__DELEGATE2_H__
#define __FOUNDATION__DELEGATE2_H__
...
template <
    ...
    typename ResultType, 
    typename ResultCombiner = _UseLastValue2,
...
#endif  // __FOUNDATION__DELEGATE2_H__
